                  ...
                  <table class="table table-user-information">
                    <tbody>
                     ...
                     <tr>
                      ...
                      <a type="submit" name="register" href='<?php echo base_url()?>Defination/agentpage'; class="btn btn-danger"><i class="fa fa-reply"></i></a>
                 <a class="btn btn-primary" flort:right href="<?php echo $base_url; ?>Defination/priint/<?php echo $view->id; ?>" target="_blank"><i class="fa fa-print"></i></a>
