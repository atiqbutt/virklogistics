          ...
          <div class="box col-sm-3" >
            ...
            <div class="box-body">
             ...
             <div class="col-md-12">
                   ...
                   <form class="form-horizontal" id="shippingForm"  onsubmit="return validateForm(this)" action="<?php echo base_url()?>Report/expense_reports" method="post" enctype="multipart/form-data">
...
<!-- <thead style="background-color:#0292e0;color:white;border:1px solid grey" id="headers">
 ...
 <thead style="background-color:#0292e0;color:white;border:1px solid grey">
    <tr class="triplist l">
      ...
      <th> <input type="checkbox" hidden value="col2"   name="col2"  checked></th>
...
<!--     <tr>
  ...
  <tbody >
    <?php
      $i=1;$cont=0;$id=0;foreach ($data as $value)  { 
