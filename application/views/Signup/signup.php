...
<head>
  ...
  <title>Virk Logistics | Registration Page</title>
...
<div class="register-box">
  <div class="register-logo">
    <a href="<?php echo base_url()?>assets/backend/index2.html"><b>Virk</b>Logistics</a>
  </div>

  <div class="register-box-body">
    <p class="login-box-msg">Register a new membership</p>

    <form action="<?php echo base_url()?>backend/Signup/save" method="post">
      ...
      <div class="row">
        <div class="col-xs-8">
          <div class="checkbox icheck">
            <label>
              <input type="checkbox"> I agree to the <a href="<?php echo base_url()?>assets/backend/#">terms</a>
            </label>
          </div>
        </div>
        <!-- /.col -->
    ...
    <a href="<?php echo base_url()?>backend/Login/index" class="text-center">I already have a membership</a>
  </div>
  <!-- /.form-box -->
</div>
<!-- /.register-box -->
