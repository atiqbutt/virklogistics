                        ...
                        <div class="header">
                            ...
                            <!--     <div class=" text-left left ">  
                                ...
                                <div>
                                    ...
                                    <center><h3 class="boxed" style="margin-top:0px !important;font-size:23px;">Product Type Information</h3></center>
                                </div>
<!--                                 
                ...
                <table>
                    <tbody>
                     ...
                     <tr>
                         ...
                         <td class="second"><?php if(isset($view)){echo ucfirst($view->heading);}  ?>
                         </td>
                      </tr>
                        
                     <tr>
                       <td class="first"><strong>Product Type:</strong></td>
                       <td class="second"><?php if(isset($view)){echo ucfirst($view->pname);}  ?></td>
                      </tr>
                      
                      <td class="first"><strong>unit:</strong></td>
                        <td class="second"><?php if(isset($view)){echo ucfirst($view->unitname);}  ?>
                        </td>
                      
                       
                        <tr>
                       <td class="first"><strong>Price:</strong></td>
                        <td class="second"><?php if(isset($view)){echo ucfirst($view->price);}  ?></td>
                      </tr>
                      
                      
                        <tr>
                       <td class="first"><strong>Description:</strong></td>
                        <td class="second"><?php if(isset($view)){echo ucfirst($view->description);}  ?></td>
                      </tr>
