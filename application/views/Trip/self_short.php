...
<ul class="nav nav-tabs">
  ...
  <li class="active"><a href="<?php echo base_url();?>Trip/self_short/">Self Short</a></li>
...
<!-- /.row -->
  ...
  <form name="myform" id="myform" action="<?php echo base_url() ?>trip/saveexpense_trip/<?php ?>" method="post" enctype="multipart/form-data">
