        ...
        <div class="col-md-12" >
          ...
          <div class="panel panel-info">
            <div class="panel-heading">
              <h3 class="panel-title">Vehicle Type Information</h3>
            </div>
            ...
            <div class="panel-body">
              <div class="row">
                  <div class="col-md-3 col-lg-3" align="center">
                   ...
                   <img alt="User Pic" src="<?php echo base_url()?>assets/Images/raw/type.jpg" width="300" height="400" class="img-responsive img-thumbnail">
                ...
                <div class=" col-md-9 col-lg-9 "> 
                  <table class="table table-user-information">
                    ...
                    <a type="submit" name="register" href='<?php echo base_url()?>Vehicle/Vehicle_type_list'; class="btn btn-danger"><i class="fa fa-reply"></i></a>
