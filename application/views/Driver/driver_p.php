                        ...
                        <div class="header">
                            ...
                            <!--     <div class=" text-left left ">  
                                ...
                                <div>
                                    ...
                                    <center><h3 class="boxed" style="margin-top:0px !important;font-size:23px;">Driver Information</h3></center>
                                </div>
<!--                                 
                ...
                <table>
                    <tbody>
                      ...
                      <td class="first"><strong>Phone Number:</strong></td>
                        ...
                        <tr>
                       <td class="first"><strong>Religion:</strong></td>
                        <td class="second"><?php if(isset($view)){echo ucfirst($view->religion);}  ?></td>
                      </tr>
                      
                      
                       <tr>
                       <td class="first"><strong>Date of Birth:</strong></td>
                        <td class="second"><?php if(isset($view)){echo ucfirst($view->dob);}  ?></td>
                      </tr>
                      
                      
                       <tr>
                       <td class="first"><strong>Date of Joining:</strong></td>
                        <td class="second"><?php if(isset($view)){echo ucfirst($view->doj);}  ?></td>
                      </tr>
                       ...
                       <tr>
                       <td class="first"><strong>Driver License:</strong></td>
                        <td class="second"><?php if(isset($view)){echo ucfirst($view->dl);}  ?></td>
                      </tr>
