        ...
        <div class="col-xs-12">
          <div class="box col-sm-12">
            <div class="box-header" >
              ...
              <h3 class="box-title">Add Contractor Information</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
             <div class="col-md-9">
                   <form class="form-horizontal" id="shippingForm" action="<?php echo base_url()?>Defination/savecontractor" method="post" enctype="multipart/form-data">
                    ...
                    <span class="input_fields_wrap"></span>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                         <input class="form-control" type="text" name="contactnumber" placeholder="Contact Person Number" onkeypress='return ValidateNumberOnly()' />
                         </div>
                      </div>
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                               <input class="form-control" type="text" name="cnic" placeholder="Enter cnic without dashes" onkeypress='return ValidateNumberOnly()' />
                      </div>
                      </div>
