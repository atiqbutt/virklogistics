        ...
        if($this->user_model->is_super())
        {
            ...
            foreach($menus as $k=>$v){
                             ...
                             $return .='    <div class="col-xs-12">
                                    <div class="box col-sm-2 col-md-2 col-lg-1 collapsed-box" style="margin-bottom:2px">
                                        <div class="box-header " >
                                            <h6 style="font-size:13px" class="box-title ">'.$v['name'].'</h6>
                                        <div class="box-tools pull-right">

<button type="button" class="btn btn-box-tool _module" value="0" >
                                            All</button>
