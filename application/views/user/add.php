            ...
            <div class="box-body">
                <form class="form-horizontal form-label-left" action="<?php echo $base_url; ?>admin/user/save" method="post">
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="fname" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="2" name="fname" placeholder="First Name" required="required" pattern="[A-Za-z ]+" title="Alphabets only" type="text">
                        </div>
                      </div>
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="lname" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="2" name="lname" placeholder="Last Name" required="required" pattern="[A-Za-z ]+" title="Alphabets only" type="text">
                        </div>
                      </div>
                      <div class="item form-group">
