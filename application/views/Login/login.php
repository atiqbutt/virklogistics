...
<head>
  ...
  <title>Virk Logistics | Log in</title>
...
<input type="hidden">
    ...
    <a href="<?php echo base_url()?>backend/Signup/index" class="text-center">Register a new membership</a>
