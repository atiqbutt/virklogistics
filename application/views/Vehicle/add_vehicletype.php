                 ...
                 <form  id="defaultForm" class="form-horizontal" action="<?php echo base_url()?>Vehicle/Vehicle_type_save" method="post" enctype="multipart/formdata">
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-md-offset-3">
                         ...
                         <button type="submit" name="register" class="btn btn-success">Add</button>&nbsp&nbsp<button type="reset" class="btn btn-warning">Reset</button>&nbsp&nbsp<button type="submit" name="register"  onclick="window.location.href='<?php echo base_url()?>Vehicle/Vehicle_type_list';" class="btn btn-danger">Cancel</button>
