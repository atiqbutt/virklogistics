          ...
          <div class="box col-sm-3" >
            ...
            <div class="box-body">
             ...
             <div class="col-md-12">
                   ...
                   <form class="form-horizontal" id="shippingForm"  onsubmit="return validateForm(this)" action="<?php echo base_url()?>Report/vehicle_expense_report" method="post" enctype="multipart/form-data">
...
<?php
    ...
    <tr class="odd gradeX" style="background-color:#f4f4f4">
      ...
      <?php if($value['vid']!=$id){?>
      <td class="col2" rowspan="<?php echo $cont?>"><?php echo $value['vehicle']?></td>
      <?php } ?>
